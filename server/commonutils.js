...
async function sendRegisterMail(rand, name, email, httpRes) {
  ...
  let mailOptions = {
    ...
    html:
      "<center><img src='https://gruppe4.testsites.info/static/golddiggertext.png'/><br>Dear new user, <br> Welcome to the crew! We wish you happy digging and hope you will have fun on our platform. But" +
      " first of all we need you to confirm your registration by clicking on the following link: <br><a href=" +
      link +
      ">Click" +
